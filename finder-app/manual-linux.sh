...
cp $toolchain_sysroot/lib/ld-linux-aarch64.so.1 lib/
cp $toolchain_sysroot/lib64/libresolv.so.2 lib64/
cp $toolchain_sysroot/lib64/libm.so.6 lib64/
cp $toolchain_sysroot/lib64/libc.so.6 lib64/
